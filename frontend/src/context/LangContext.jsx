...
const STRINGS = {
  en: {
    ...
    history_private_note: 'Saved only on this device. Other people using this app cannot see it.',
    history_signed_in_note: 'Saved to your account — only you can see it, on any device.',
    history_login_cta: 'Sign in to save your history to your account',
    ...
    auth_login_subtitle: 'Welcome back — log in to see your saved predictions.',
    auth_signup_subtitle: 'Save your prediction history securely and access it from any device.',
  ...
  rw: {
    ...
    history_private_note: 'Bibikwa kuri iyi telefoni/mudasobwa gusa. Abandi bakoresha iyi porogaramu ntibabibona.',
    history_signed_in_note: 'Bibitswe kuri konti yawe — wowe wenyine ubibona, kuri buri gikoresho.',
    history_login_cta: 'Injira kugirango ubike amateka yawe kuri konti yawe',
    ...
    auth_login_subtitle: 'Murakaza neza — injira urebe ibyo wateganyije byabitswe.',
    auth_signup_subtitle: 'Bika amateka y\'ibyo wateganyije mu mutekano kandi ubone kuri buri gikoresho.',
