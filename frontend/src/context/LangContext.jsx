...
const STRINGS = {
  en: {
    ...
    history_signed_in_note: 'Saved to your account — only you can see it, on any device.',
  ...
  rw: {
    ...
    history_signed_in_note: 'Bibitswe kuri konti yawe — wowe wenyine ubibona, kuri buri gikoresho.',
